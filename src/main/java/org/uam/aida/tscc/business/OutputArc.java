...
public class OutputArc extends Arc implements Inscription {
    ...
    //private String executeText = "getTransition().getTokenSet()"; CHANGE
    //TODO put this in a sublcass of OutputArc
    //private String executeText = "currentCase";
    private String executeText = "currentCase.getObject()@currentCase.getTimestamp()";

    /** Constructor to create an output arc. */
    public OutputArc(Place place, Transition transition) {
        this.id = "o" + this.id + "_" + transition.getId() + "_" + place.getId();
        //this.id = "o" + this.id;
        this.place = place;
