 ...
 * @author victor
 */
public class LessThanTSG extends NumericalComparisonTSG {
    ...
    public LessThanTSG(
        ...
        super(
                ...
                epsilon, 
                eventType, 
                minFulfillmentDuration, 
                maxUnfulfillmentPercentage, 
                granularity, 
                varname
        );
    }

    public LessThanTSG(String varname, Double value, boolean strict) {
        super(value, strict, varname);
    }

    public LessThanTSG(String varname, Double value, boolean strict, LifecycleStage stage) {
