...
import org.uam.aida.tscc.business.Simulation;
...
public class Canvas extends javax.swing.JPanel
    ...
    public void paintComponent(java.awt.Graphics graphics) {
        ...
        //NEW: detect if we must adjust the maximum height
        /*
        Boolean adjustmentNeeded = figures.values()
                .stream()
                .anyMatch((Object o) -> {
                    AbstractFigure element = (AbstractFigure) o;                
                    Double distanceToBound = Math.abs(element.getPosition().getY() - this.getHeight());
                    return distanceToBound < 100;
                });
